...
<?php include($_SERVER["DOCUMENT_ROOT"]."/_includes/header.php"); ?>
		...
		<div id="main" role="main">
			<div class="interview-mod-article" id="top">
				<img class="interview-img-article fade-me" src="/_img/_mcpherson/topper-tara-mcpherson.jpg" alt="Tara McPherson Topper" />
				...
				<div class="interview-page-content">
					...
					<div class="intro-mod-article">
						<div class="intro-content">
							<h1 class="interview-name">Tara McPherson</h1>
					...
					<h4 class="interview-q">
						Orci arcu mattis et a integer nisl. A nulla torquent urna justo nisi et, amet lacus, egestas ipsum penatibus nullam, fames duis sed tortor pretium quis?
					</h4> <!-- /interview-q -->	
					...
					<div class="sponsor-end">
						<img class="sponsor-end-img" src="/_img/sponsor-logo-3.png" />
						<h5 class="sponsor-end-txt"><span class="sponsor-end-txt-lt">This Interview was Brought to You by:</span> Dribbble, Facilitators of Solid Design and Dialogue since 2009.</h5>
					</div> <!-- /sponsor-end -->	
		...
		<!-- Article-End -->
		<?php include($_SERVER["DOCUMENT_ROOT"]."/_includes/article-end.php"); ?>


		<!-- Nav-Tabs -->
		<?php include($_SERVER["DOCUMENT_ROOT"]."/_includes/nav-tabs.php"); ?>
