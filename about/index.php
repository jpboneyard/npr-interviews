<?php 
$title = "About - The National Poster Retrospecticus Interview Series";
...
<?php include($_SERVER["DOCUMENT_ROOT"]."/_includes/header.php"); ?>
	...
	<div id="main" role="main">
		<div class="interview-mod" id="top">
			<img class="interview-img" src="/_img/topper-about.gif" alt="National Poster Retrospecticus Topper" />
			...
			<div class="interview-page-content">
				<div class="intro-mod">
					<div class="intro-content">
						<div class="overline">INTERVIEW SERIES & POSTER SHOWS</div>
						<h1>The NPR Story</h1>
					</div> <!-- /intro-content -->
				</div> <!-- /intro-mod -->
